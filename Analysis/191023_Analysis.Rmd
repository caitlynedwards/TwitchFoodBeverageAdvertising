...
a <- ggplot(data = dat_aggregate_total, aes(x = reorder(categories_factor, -total_messages), y = total_messages, fill = categories_factor)) +
...
ggsave("Masterson_Figure4.tiff", a, dpi = 600, width=5.75, height=2.25)

b <- ggplot(data = dat_aggregate_total, aes(x = reorder(categories_factor, -total_views), y = total_views, fill = categories_factor)) +
...
ggsave("Masterson_Figure5.tiff", b, dpi = 600, width=5.75, height=2.25)
